            ...
            <form class="needs-validation" novalidate method="POST" 
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="textarea" class="form-control" id="keterangan" name="keterangan"
                            placeholder="Keterangan" require ></textarea>
