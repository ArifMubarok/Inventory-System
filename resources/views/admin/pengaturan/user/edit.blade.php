      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="/data-user/{{ $users->id }}">
                @csrf
                @method('put')
              <div class="card-body">
                <div class="form-group">
                  <label for="username">Nama*</label>
                  <input type="text" name="username" id="username" class="form-control @error('username') is-invalid @enderror" placeholder="Nama" require autofocus value="{{ old('username', $users->username) }}">
                  @error('username')
                  ...
                  <div class="col-sm-12">
                      ...
                      <br>
                        <select id="role" class="form-control @error('role') is-invalid @enderror" name="role">
                          <option value="{{ old('role', $users->role) }}">{{ old('role', $users->role) }}</option>
                  ...
                  <div class="col-sm-12">
                      ...
                      <br>
                        <select id="departemen" class="form-control @error('departemen_id') is-invalid @enderror" name="departemen_id">
                          ...
                          @if (old('departemen_id', $users->departemen_id == $departemen->departemen_id))
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email" require value="{{ old('email', $users->email) }}">
                  @error('email')
                      <div class="invalid-feedback">
                          {{ $message }}
                      </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nomor_hp" id="nomor_hp" class="form-control @error('nomor_hp') is-invalid @enderror" placeholder="No. Hp" require value="{{ old('nomor_hp', $users->nomor_hp) }}">
                  @error('nomor_hp')
                      <div class="invalid-feedback">
                          {{ $message }}
                      </div>
                  ...
                  <div class="col-sm-12">
                      ...
                      <br>
                        <select id="status" class="form-control @error('status') is-invalid @enderror" name="status">
                          <option value="{{ old('status', $users->status) }}">@if ($users->status == '0')
                              Aktif
                          @else
                              Non-Aktif
                          @endif</option>
