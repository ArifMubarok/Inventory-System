...
@section('content')
	...
	@if (isset($item->bagian))
		<form action="{{ route('sarpras.cek-barang.lapor') }}" method="get">
			@csrf
	...
	@endif
	<a href="{{ route('sarpras.cek-barang.index') }}" class="btn btn-primary float-xl-right mr-2"><i class="fas fa-lg fa-fw m-r-10 fa-search"></i>Cek Barang</a>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
			...
			<div class="panel panel-default panel-with-tabs" data-sortable-id="ui-unlimited-tabs-2">
				...
				<div class="panel-body tab-content">
					...
					<div class="tab-pane fade  active show" id="nav-tab2-1">
						@include('pages.sarpras.cek-barang.detail_barang.isi_menu.data_barang')
					</div>
					<!-- end tab-pane -->
					<!-- begin tab-pane -->
					<div class="tab-pane fade" id="nav-tab2-2">
						@include('pages.sarpras.cek-barang.detail_barang.isi_menu.data_pengadaan')
					</div>
					<!-- end tab-pane -->
					<!-- begin tab-pane -->
					<div class="tab-pane fade" id="nav-tab2-3">
						@include('pages.sarpras.cek-barang.detail_barang.isi_menu.riwayat_penempatan')
					</div>
					<!-- end tab-pane -->
					<!-- begin tab-pane -->
					<div class="tab-pane fade" id="nav-tab2-4">
						@include('pages.sarpras.cek-barang.detail_barang.isi_menu.riwayat_laporan')
					</div>
					<!-- end tab-pane -->
