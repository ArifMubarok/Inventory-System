...
class CekController extends Controller
{
    ...
    {
        return view('pages.sarpras.cek-barang.index');
    }
    ...
    public function show(Request $request)
    {
        try {
            ...
            return view('pages.sarpras.cek-barang.detail_barang.menu', [
                'barang' => $penempatan,
    ...
    public function lapor(Request $request)
    {
        ...
        return view('pages.sarpras.cek-barang.lapor', [
            'barang' => $barang,
            'barang_id' => $idbarang
        ]);
    }
    ...
    public function kirim(LaporForm $request)
    {
        ...
        return redirect(route('sarpras.laporan-barang.index'))->withInput()->withToastSuccess('success report data');
    }
}
