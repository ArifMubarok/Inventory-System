...
use App\DataTables\Sarpras\Barang\OpnameDataTable;
use App\DataTables\Sarpras\Barang\OpnameAddDataTable;
...
class OpnameController extends Controller
{
    ...
    {
        return $datatable->render('pages.sarpras.barang.opname.index');
    }
    ...
    public function create(OpnameAddDataTable $datatable)
    {
        ...
        return $datatable->render('pages.sarpras.barang.opname.add-edit', [
            'data' => $data,
            'lokasi' => $lokasi,
            'kategori' => $kategori
        ]);
    ...
    public function store(OpnameForm $request)
    {
        ...
        return redirect(route('sarpras.barang.proses-opname.index'))->withInput()->withToastSucces('success saving data');
    }
