...
use App\DataTables\Sarpras\Barang\MutasiLokasiDataTable;
...
class MutasiLokasiController extends Controller
{
    ...
    public function index(MutasiLokasiDataTable $datatable)
    {
        ...
        return $datatable->render('pages.sarpras.barang.mutasi_lokasi.index', [
    ...
    public function store(MutasiLokasiForm $request)
    {
        ...
        return redirect(route('sarpras.barang.mutasi-lokasi.index'))->withInput()->withToastSuccess('Success move location');
    }
