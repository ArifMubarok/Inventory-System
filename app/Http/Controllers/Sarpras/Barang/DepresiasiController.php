...
use App\DataTables\Sarpras\Barang\DepresiasiDataTable;
...
class DepresiasiController extends Controller
{
    ...
    {
        return $datatable->render('pages.sarpras.barang.depresiasi.index');
    }
    ...
    public function store(DepresiasiForm $request)
    {
        ...
        return view('pages.sarpras.barang.depresiasi.detail');
    }
}
