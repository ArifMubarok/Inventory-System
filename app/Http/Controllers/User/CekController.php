...
class CekController extends Controller
{
    ...
    {
        return view('pages.user.cek-barang.index');
    }
    ...
    public function show(Request $request)
    {
        try {
            ...
            return view('pages.user.cek-barang.detail_barang.menu', [
                'barang' => $penempatan,
    ...
    public function lapor(Request $request)
    {
        ...
        return view('pages.user.cek-barang.lapor', [
            'barang' => $barang,
            'barang_id' => $idbarang
        ]);
    }
    ...
    public function kirim(LaporForm $request)
    {
        ...
        return redirect(route('user.laporan-barang.index'))->withInput()->withToastSuccess('success report data');
    }
}
