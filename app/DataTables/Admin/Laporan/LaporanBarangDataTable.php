...
class LaporanBarangDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('penempatan.pengadaan.databarang.name')->width(500)->title('Barang'),
            ...
            Column::make('penempatan.lokasi.name')->width(80)->title('Lokasi'),
            Column::make('penempatan.pengadaan.kondisi')->width(140)->title('Kondisi'),
        ];
    }
