...
namespace App\DataTables\Sarpras;
...
class LaporBarangDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                $btn = $btn . '<a href="' . route('sarpras.laporan-barang.show', $row->id) . '" class="btn '.$warna.' buttons-edit">'.$tulis.'</a>';
                $btn = $btn . '</div>';
                return $btn;
            })
    ...
    {
        return 'LaporBarang_' . date('YmdHis');
    }
}
